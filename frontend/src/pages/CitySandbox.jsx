...
export default function CitySandbox() {
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold mb-1 gradient-text">🏗️ City Generator & Leak Sandbox</h2>
            <p className="text-sm text-[var(--color-text-dim)] mb-6">Generate a network, place leaks, and watch the model predict.</p>

            {/* Controls */}
            <SectionHeader>Network Parameters</SectionHeader>
            <div className="grid grid-cols-4 gap-4 mb-6">
                {[['Grid Rows', rows, setRows, 3, 15], ['Grid Columns', cols, setCols, 3, 15],
                ['Sensors', nSensors, setNSensors, 2, 20]].map(([label, val, setter, min, max]) => (
                    <div key={label}>
